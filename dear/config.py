...
def get_config():
    ...
    # Prior settings
    #parser.add_argument('--prior', type=str, default='linscm', choices=['gaussian', 'uniform', 'linscm', 'nlrscm'],                        help='latent prior p_z')
...
def extend_args(args):
    args.image_size = 64
    args.prior = 'lincsm'
    args.enc_arch = 'resnet18'
    args.enc_dist = 'gaussian'
    #args.enc_dist = 'deterministic'
    #args.enc_fc_size = 1024
    args.enc_fc_size = 128
    args.enc_noise_dim = 32
    args.dec_arch = 'sagan'
    args.dec_dist = 'implicit'
    args.g_conv_dim = 32
    args.dis_fc_size = 128
    args.d_conv_dim = 32
