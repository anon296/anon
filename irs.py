...
def scalable_disentanglement_score(gen_factors, latents, diff_quantile=0.99):
    ...
    score_dict = {}
    score_dict["disentanglement_scores"] = disentanglement_scores.tolist()
    score_dict["avg_score"] = avg_score
    return score_dict

if __name__ == '__main__':
    muts = np.load('test_data.npz')['latents']
    yts = np.load('test_data.npz')['gts']
    print(scalable_disentanglement_score(yts,muts))
